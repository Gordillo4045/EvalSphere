...
import { Button, Card, CardBody, CardHeader, Select, SelectItem, Spinner, Input, ButtonGroup, Snippet, Badge, Dropdown, DropdownTrigger, DropdownMenu, DropdownItem } from "@heroui/react";
            ...
            <main className="flex-1 flex flex-col overflow-hidden ml-[3.5rem] md:ml-20">
                <div className="fixed top-0 right-0 left-[3.5rem] md:left-20 shadow backdrop-blur-sm backdrop-saturate-150 border-r border-gray-300 dark:border-gray-700/50 z-40 px-2 md:px-3 py-2 border-b ">
                    <div className="w-full flex justify-between items-center">
                        ...
                        <div className="flex items-end flex-grow justify-center">
                            <BlurIn word={`Panel de Control de ${company.name}`} className="text-lg md:text-xl font-semibold text-center" />
